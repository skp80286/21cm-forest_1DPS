...
from BayesianCNN21cm import create_bayesian_model,train_model, test_model, report_test_scores, sample_posterior, plot_posterior
import argparse
import glob
...
logger.info("Posterior mean:", samples.mean(dim=0))
logger.info("Posterior std :", samples.std(dim=0))
